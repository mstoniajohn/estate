    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone_number', phonenumber_field.modelfields.PhoneNumberField(default='+7184535550', max_length=30, region=None, verbose_name='Phone Number')),
                ...
                ('is_buyer', models.BooleanField(default=False, help_text='Are You looking to buy a house?', verbose_name='Buyer')),
                ('is_seller', models.BooleanField(default=False, help_text='Are you looking to buy a house', verbose_name='Seller')),
                ('is_agent', models.BooleanField(default=True, help_text='Are you and agent?', verbose_name='AgenT')),
