...
class Profile(TimeStampedUUIDModel):
    ...
    phone_number = PhoneNumberField(verbose_name=_("Phone Number"),max_length=30, default="+7184535550")
    about_me = models.TextField(verbose_name=_("About Me"), default="Say something about yourself")
    license = models.CharField(max_length=20, null=True, blank=True, verbose_name=_("License"))
    ...
    is_buyer = models.BooleanField(verbose_name=_("Buyer"), default=False, help_text=_("Are You looking to buy a house?"))
    is_seller = models.BooleanField(verbose_name=_("Seller"), default=False,help_text=_("Are you looking to buy a house"))
    is_agent = models.BooleanField(verbose_name=_("AgenT"), default=True, help_text=_("Are you and agent?"))
